...
async def restart(client, m: Message):
    ...
    await jmthon.edit("8")
    await jmthon.edit("9")
    await jmthon.edit("**تم اعادة تشغيل سورس دايفل ميوزك بنجاح ✓**")
...
🛠 هذه هي قائمـة اوامر السـورس @C125C 
...
• {HNDLR}الاوامر - لعرض اوامر سورس ميوزك دايفل @E125E
