...
async def restart(client, m: Message):
    ...
    await jmthon.edit("8")
    await jmthon.edit("9")
    await jmthon.edit("**تم اعادة تشغيل سورس عبيد ميوزك بنجاح ✓**")
...
async def repo(client, m: Message):
    await m.delete()
    REPZ = f"""
<b>- اهلا بك عزيزي {m.from_user.mention}!
• تم تعديل وتطوير هاذ البوت ليقوم بتشغيل الأغاني والفيديو في الممكالمات 
• `بدون صلاحيات اشراف فقط قم بارسال  `الاوامر
• للمزيد قم بمراسلة المطورين سنرد عليك باقرب فرصة 
• دايفل - @E125E
• عبدالله  - @JJ64J 
===========================================
"""
