...
**🎧  طلب تنزيل من الحلو :** {message.from_user.mention}
"""
...
async def vsong(client, message: Message):
    ...
    pablo = await client.send_message(message.chat.id, f"**🔎 انتظرني جاي ابحث عمري  ** `{urlissed}`")
    if not urlissed:
        await pablo.edit(
            "• اول شي حط نص ابحث عنة 🙂⚙️ "
        )
        return
...
**🎧 طلب تحميله من الحلو:** {message.from_user.mention}
"""
